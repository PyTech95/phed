...
import { connectionLabel as decisionLabel } from '../../lib/connectionStatus';
import { formatISTDateTime as dateText } from '../../lib/indianDateTime';
  ...
  return (
    <div className="space-y-4 text-sm" data-testid="phed-map-survey-details">
      ...
      >
        ...
        {survey && <ConnectionTypeBadge survey={survey} testId="phed-map-surveyor-decision" />}
      </div>
      ...
      >
        ...
        {survey ? (
          <div className="border-t pt-3" style={{ borderColor: 'var(--phed-border)' }}>
            ...
            <div className="mt-3"><OfficeDocumentsStatus water={water} testId="map-office-documents-status" /></div>
          </div>
        ) : (
